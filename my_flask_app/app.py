...
# Base directory of this app.py file - works no matter where the project
# is placed on disk, instead of the old hard-coded /home/timo/... paths.
...
def serve_directory(root_directory, relative_path):
    ...
    directory = os.path.join(root_directory, relative_directory)
    return send_from_directory(directory, filename)

@app.route('/files/<path:relative_path>')
def serve_files(relative_path):

    root_directory = os.path.join(BASE_DIR, 'files')
